...
export default function CategoryPage() {
    ...
    return (
        <div>
            <section className="bg-[#082119] text-white py-16">
                <div className="section-container">
                    ...
                    <span className="eyebrow text-[#C5A059]">{category.items.length} Destinations</span>
                        ...
                        {CATEGORY_LIST.map((cat) => (
                            <Link
                                ...
                                className={`px-5 py-2.5 rounded-full border text-sm font-medium transition-colors duration-200 ${cat.key === categoryKey
                                        ...
                                        : 'border-line text-ink-soft hover:border-[#0F382C] hover:text-[#0F382C]'
                                    }`}
                            >
                                {cat.shortLabel}
                            </Link>

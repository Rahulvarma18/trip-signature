  ...
  if (submitted) {
    return (
      <div className="bg-paper rounded-[10px] p-10 shadow-deep text-center relative">
        <CheckCircle2 size={52} className="stroke-[#3D7A4F] mx-auto mb-4" />
    ...
    <div className="bg-paper rounded-[10px] p-9 sm:p-10 shadow-deep relative">
      ...
      <form onSubmit={handleSubmit} noValidate className="relative">
        ...
        <div className="bg-ivory border border-line rounded-md px-4.5 py-4 flex items-center gap-3.5 mb-1">
          <span className="flex items-center gap-1.5 text-[11.5px] font-semibold uppercase tracking-wide text-[#3D7A4F] flex-none">
            <ShieldCheck size={15} />
            Verified Human
          </span>
          <div className="bg-[#0F382C] text-white rounded-md px-4 py-2.5 font-semibold text-sm whitespace-nowrap">
            {captcha.a} + {captcha.b} = ?
          </div>
          <input
            type="text"
            ...
            className="flex-1 min-w-0 border border-line rounded-md px-3 py-2.5 text-sm focus:border-[#0F382C] outline-none"
          />
        </div>
...
function Field({ label, required, optional, error, children }) {
  return (
    <div className="mb-4.5">
      <label className="block text-[11px] font-semibold tracking-wide uppercase text-[#0F382C] mb-1.5">
...
function IconInput({ icon: Icon, withCaret, children }) {
  return (
    <div className="flex items-center gap-2.5 border border-line rounded-md px-3.5 bg-[#F2F6F4]/50 focus-within:border-[#0F382C] focus-within:ring-2 focus-within:ring-[#F2F6F4] transition-all">

    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
      ...
      <div className="relative bg-white rounded-md shadow-deep w-full max-w-md p-8 sm:p-9">
        <button
          onClick={onClose}
          aria-label="Close"
          className="absolute top-5 right-5 text-ink-soft hover:text-[#0F382C] transition-colors"
        >
          <X size={20} />
        </button>
        ...
        <form onSubmit={handleSubmit} noValidate>
          {isSignup && (
            <div className="mb-4">
              ...
              <div className="flex items-center gap-2.5 border border-line rounded-md px-3.5 bg-[#F2F6F4]/50 focus-within:border-[#0F382C]">
        ...
        <p className="text-center text-[13px] text-ink-soft mt-5">
          ...
          <button
            ...
            className="text-[#0F382C] font-semibold hover:underline"
          >

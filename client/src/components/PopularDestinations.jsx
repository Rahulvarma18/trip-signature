...
const DESTINATIONS = [
    {
        ...
        image: 'https://images.unsplash.com/photo-1626015449732-ce7c6b2d1e2e?auto=format&fit=crop&w=900&q=80',
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1621831981176-1a4f14b7db85?auto=format&fit=crop&w=900&q=80',
    ...
    return (
        <section ref={sectionRef} className="py-16 overflow-hidden">
            <div className={`section-container mb-8 flex items-end justify-between transition-opacity duration-700 ${isVisible ? 'animate-hero-title' : 'opacity-0'}`}>
                ...
                <Link
                    to="/#packages"
                    className="hidden sm:inline-flex items-center gap-1.5 text-sm font-medium text-[#111111] hover:text-[#C9A86A] transition-colors group"
                >
                    View all <ArrowUpRight size={15} className="transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 text-[#C9A86A]" />
                </Link>
            </div>
            ...
            <div className="section-container relative">
                ...
                >
                    {DESTINATIONS.map((dest, idx) => (
                        ...
                        >
                            ...
                            <div className="absolute top-4 right-4 w-10 h-10 rounded-full bg-[#FAF7F2]/90 backdrop-blur-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 shadow-md border border-[#C9A86A]/40">
                                <ArrowUpRight size={18} className="text-[#111111] transition-transform group-hover:scale-110" />
                            </div>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-6 transition-transform duration-300 group-hover:-translate-y-1">
                                ...
                                <div className="flex items-center gap-2 mb-2.5">
                                    <span className="bg-black/40 backdrop-blur-md text-[#FAF7F2] text-[11px] font-medium px-3 py-1 rounded-full border border-white/20 shadow-sm">
                                        {dest.country}
                                    </span>
                                    <span className="flex items-center gap-1 text-white text-[12px] font-medium bg-black/40 backdrop-blur-md px-2.5 py-1 rounded-full border border-white/15">
                                        <Star size={11} className="fill-[#C9A86A] stroke-[#C9A86A]" />
                                        {dest.rating}
                                    </span>
                                </div>

                                {/* Name */}
                                <h3 className="font-display text-3xl font-semibold text-[#FAF7F2] leading-tight mb-1.5 drop-shadow-sm">
                                    {dest.name}
                                </h3>
                ...
                {canScrollLeft && (
                    <button
                        ...
                        className="absolute -left-3 sm:-left-5 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-[#111111] text-[#FAF7F2] flex items-center justify-center shadow-deep hover:bg-[#C9A86A] hover:text-[#111111] transition-all duration-200 hover:scale-110 active:scale-95 z-10 border border-[#C9A86A]/40"
                    >
                ...
                {canScrollRight && (
                    <button
                        ...
                        className="absolute -right-3 sm:-right-5 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-[#111111] text-[#FAF7F2] flex items-center justify-center shadow-deep hover:bg-[#C9A86A] hover:text-[#111111] transition-all duration-200 hover:scale-110 active:scale-95 z-10 border border-[#C9A86A]/40"
                    >

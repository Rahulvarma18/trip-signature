...
const slides = [
  {
    ...
    reviews: 639,
    rating: 4.8,
    // Beach-level shot looking to horizon: sky fills upper 60%, water at base
    image: '/maldives.png',
    position: 'bg-center',
  },
  {
    ...
    reviews: 784,
    rating: 4.9,
    // Snow peaks against open sky: sky dominates center, mountains at bottom third
    image:
      '/kedar.png',
    position: 'bg-center',
  },
  {
    ...
    reviews: 921,
    rating: 4.8,
    // Terraced hillside at dusk: even warm tones fill frame, no single focal point
    image:
    ...
    <section className="relative h-screen min-h-[600px] flex items-center overflow-hidden">
      ...
      <div className="section-container relative z-10 text-center w-full flex flex-col items-center">
        ...
        <a
          key={`cta-${current}`}
          href="#packages"
          className="inline-flex items-center gap-3 border border-white/70 text-white px-10 py-4 text-sm font-medium tracking-widest uppercase hover:bg-white hover:text-ink transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-2xl animate-hero-title"

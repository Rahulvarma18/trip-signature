      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map(({ icon: Icon, title, desc }) => (
            ...
            >
              <div className="w-[52px] h-[52px] rounded-full bg-[#F3ECE1] border border-[#E8E2D7] flex items-center justify-center mx-auto mb-4.5">
                <Icon size={24} className="stroke-[#111111]" />
              </div>
